...
namespace Game.Domain.Tests
{
    public class DecisionGraphTests
    {
        ...
        static LevelGraph ThreeNodesInALine()
        {
            ...
            builder.AddNode(new TilePosition(elevation: 0, x: 5, y: 0), NodeType.Boss, value: 10);

            builder.Connect(
                new TilePosition(elevation: 0, x: 3, y: 0),
                new TilePosition(elevation: 0, x: 5, y: 0),
                new[] { new TilePosition(elevation: 0, x: 4, y: 0) });
            builder.Connect(
